...
const Footer = () => {
  ...
  return (
    <div className="flex flex-col justify-center px-5 lg:px-[6.25rem] py-10 lg:py-12 bg-primary-800 gap-8 w-full">
      {/* -------- upper half -------- */}
      <div className="flex flex-col lg:flex-row justify-between">
        ...
        <div className="flex flex-col gap-10">
          ...
          <Link href={"/"} className="flex items-center gap-6">
            <Image
              ...
              width={isMobile ? 36.72 : 43.28}
              height={isMobile ? 36.72 : 43.28}
              alt="altgreenery-logo"
            />
            <p className="font-fraunces text-xl lg:text-2xl font-black text-primary-100 leading-9">
              Altgreenery
            </p>
          </Link>
          {/* -------- address and email -------- */}
        ...
        <div className="flex flex-col mt-10 lg:mt-0 items-start lg:items-end gap-10 lg:gap-[1.875rem]">
          {/* -------- connect with us and socials -------- */}
          <div className="flex flex-col items-start lg:items-end gap-4">
            <p className="font-arimo lg:text-right text-primary-300 lg:text-neutral-300 leading-5">
              Connect with us :
            </p>
          ...
          {/* -------- mailing list -------- */}
          <div className="flex flex-col gap-4 lg:gap-[0.9375rem]">
            <p className="font-arimo lg:text-right text-neutral-300 leading-5">
